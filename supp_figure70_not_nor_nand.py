...
#                  dA1  dA2  
dA_tot = np.array([0, 250]) # total activator added
#                 G1  G2  G3
...
plt.subplot(3,4,5)
plt.plot(sim_t/3600,G2/G_tot[1],color='r',linewidth=2,linestyle='-')
plt.ylabel('Fraction ON',fontsize=fs,weight='bold')
plt.xticks(fontsize=fs,weight='bold')
plt.yticks(fontsize=fs,weight='bold')
ax1 = plt.gca()
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([0,  0,  150]) # total activator added
#                 G1  G2  G3
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([250,  0,  150]) # total activator added
#                 G1  G2  G3
G_tot = np.array([6, 6, 25]) # total genelet added
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([250, 250, 150]) # total activator added
#                 G1  G2  G3
G_tot = np.array([6, 6, 25]) # total genelet added
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([0,  0,  550]) # total activator added
#                 G1  G2  G3
G_tot = np.array([6, 6, 25]) # total genelet added
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([250,  0, 550]) # total activator added
#                 G1  G2  G3
G_tot = np.array([6, 6, 25]) # total genelet added
...
# Define initial conditions
#                  dA1  dA2  dA3
dA_tot = np.array([250, 250, 550]) # total activator added
#                 G1  G2  G3
G_tot = np.array([6, 6, 25]) # total genelet added
