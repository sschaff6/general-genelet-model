...
TSNf.simulate(t_vec2,2,dA=['NA',250,250])

t_vec3 = np.linspace(t_vec2[-1]/3600,16,1001)*3600 # seconds

''' simulating the TSN model after adding rR1 to switch to State 3 '''
TSNf.simulate(t_vec3,3,rR=[10000,'NA','NA'])
...
fs = 13
plt.figure()
plt.suptitle('TSN: State 1 to ?',fontsize=fs+2,weight='bold')
plt.subplot(3,3,1)
